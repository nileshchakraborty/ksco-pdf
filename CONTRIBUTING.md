# Contributing to ksco-PDF

Thank you for your interest in contributing to ksco-PDF! There are many ways to contribute other than writing code. For example, reporting bugs, creating suggestions, and adding or modifying translations.
...
If you would like to add or modify a translation, please see [How to add new languages to ksco-PDF](HowToAddNewLanguage.md). Also, please create a Pull Request so others can use it!

## Docs

Documentation for ksco-PDF is handled in a separate repository. Please see [Docs repository](https://github.com/ksco-Tools/ksco-Tools.github.io) or use the "edit this page"-button at the bottom of each page at [https://docs.kscoPDF.com/](https://docs.kscoPDF.com/).
