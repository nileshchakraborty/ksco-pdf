<p align="center">
  <img src="https://raw.githubusercontent.com/ksco-Tools/ksco-PDF/main/docs/ksco.png" width="80">
  <br>
  <h1 align="center">ksco-PDF</h1>
</p>

# How to add new languages to ksco-PDF

Fork ksco-PDF and create a new branch out of `main`.

Then add a reference to the language in the navbar by adding a new language entry to the dropdown:

- Edit the file: [languages.html](https://github.com/ksco-Tools/ksco-PDF/blob/main/src/main/resources/templates/fragments/languages.html)
...
- [messages_en_GB.properties](https://github.com/ksco-Tools/ksco-PDF/blob/main/src/main/resources/messages_en_GB.properties)
