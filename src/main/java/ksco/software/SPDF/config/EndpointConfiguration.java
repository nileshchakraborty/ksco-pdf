...
public class EndpointConfiguration {
    ...
    private final Map<String, Boolean> endpointStatuses = new ConcurrentHashMap<>();
    ...
    public EndpointConfiguration(
        ...
        this.runningProOrHigher = true; // Always true to enable all features
        init();
