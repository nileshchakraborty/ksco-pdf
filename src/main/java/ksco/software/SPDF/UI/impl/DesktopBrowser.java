package ksco.software.SPDF.UI.impl;
...
import ksco.software.SPDF.utils.UIScaling;

@Component
@Slf4j
@ConditionalOnProperty(name = "ksco_PDF_DESKTOP_UI", havingValue = "true", matchIfMissing = false)
public class DesktopBrowser implements WebBrowser {
    ...
    private void setupTrayIcon(Image icon) {
        ...
        try {
            ...
            // Create tray icon
            trayIcon = new TrayIcon(icon, "ksco-PDF", popup);
