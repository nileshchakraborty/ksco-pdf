...
import ksco.software.SPDF.model.PdfMetadata;

@Service
public class PdfMetadataService {

    private final ApplicationProperties applicationProperties;
    private final String kscoPDFLabel;
    private final UserServiceInterface userService;
    private final boolean runningProOrHigher;

    public PdfMetadataService(
            ApplicationProperties applicationProperties,
            @Qualifier("kscoPDFLabel") String kscoPDFLabel,
            @Qualifier("runningProOrHigher") boolean runningProOrHigher,
            @Autowired(required = false) UserServiceInterface userService) {
        this.applicationProperties = applicationProperties;
        this.kscoPDFLabel = kscoPDFLabel;
    ...
    private void setNewDocumentMetadata(PDDocument pdf, PdfMetadata pdfMetadata) {
        ...
        if (pdfMetadata.getKeywords() != null) {
