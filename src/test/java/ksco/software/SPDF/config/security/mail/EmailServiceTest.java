package ksco.software.SPDF.config.security.mail;
...
import ksco.software.SPDF.model.api.Email;
...
public class EmailServiceTest {
    ...
    void testSendEmailWithAttachment() throws MessagingException {
        ...
        when(mailProperties.getFrom()).thenReturn("no-reply@ksco-software.com");
